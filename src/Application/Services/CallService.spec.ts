...
describe("CallService", () => {
  ...
  it.effect(
    "injects bearer authorization and forwards method body and non-hop-by-hop headers",
    () =>
      Effect.gen(function* () {
...
function makeOAuth2Client(
  refreshTokens: Ref.Ref<ReadonlyArray<string>>,
  behavior: "success" | "failRefresh",
) {
  return {
